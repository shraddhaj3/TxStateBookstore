		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="phone-label" class="property-label"><g:message code="user.phone.label" default="Phone" /></span>
						...
						<%--<span class="property-value" aria-labelledby="phone-label"><g:formatNumber number="${userInstance?.phone}" type="number" locale="${Locale.CANADA}"/>--%>
					<span class="property-value" aria-labelledby="phone-label">${userInstance?.phone.encodeAsHTML()} </span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="addresses-label" class="property-label"><g:message code="user.addresses.label" default="Addresses" /></span>
						...
						<span class="property-value" aria-labelledby="addresses-label"><g:link controller="address" params="['user.id': userInstance?.id]" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>
						</g:each>
			...
			<g:form url="[resource:userInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					...
					<%--<g:link controller="address" action="add" params="['user.id': userInstance?.id]">Next</g:link>	--%>				
				</fieldset>
			</g:form>
		</div>
	</body>
